export const TwitterIcon = ({height, width, stroke, fill}) => {
    return (
        <svg width={width || 29} height={height || 25} viewBox="0 0 29 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M24.5 6.90067C26.5 11.4007 19.5 29.4007 1 21.9007C3.7997 20.8971 6 21.0742 8 18.9007C4.5 17.9007 3.5 15.9007 3.5 15.9007C3.5 15.9007 5.73144 15.7176 6.5 15C1.5 13 1 9.40067 1 9.40067H4.5C0.5 5.90067 2 2.40067 2 2.40067C2 2.40067 5.5 7.40067 13.5 7.90067C15.3075 6.38422 12.315 4.29206 16.5 1.90066C20.5 -0.385001 23 2.40067 23 2.40067L27 1.90067L24.5 4.40067L28 3.90067C28 3.90067 25.9107 5.57912 24.5 6.90067Z" fill={fill || '#1D9BF0'} stroke={stroke || '#1D9BF0'} strokeLinejoin="round"/>
        </svg>
